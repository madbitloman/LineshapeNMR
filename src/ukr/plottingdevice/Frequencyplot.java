...
public class Frequencyplot extends ApplicationFrame {
/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
int size =FrequencySwept.size;
//int dla= Complexmatan.dlinna(size);
public Frequencyplot(final String title, double[][] all) {
   ...
   // xAxis.setRange(0, 4);
    ...
    File imageFile = new File("FrequencyGraph.png");
    int width = 1024;
    int height = 768;
